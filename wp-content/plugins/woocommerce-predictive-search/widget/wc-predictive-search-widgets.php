...
jQuery(document).ready(function() {
	...
	jQuery("#pp_course_<?php echo $id;?>").result(function(event, data, formatted) {
		...
		<form autocomplete="off" action="<?php echo "http://devel.corb.mx/nafarrate/";?>" method="get" class="fr_search_widget" id="fr_pp_search_widget_<?php echo $id;?>">
        	<?php
            ...
            <?php } ?>
   			...
   			<!-- this input was changed from type text to type search for SEO  -->
			<input type="search" id="pp_course_<?php echo $id;?>" onblur="if (this.value == '') {this.value = '<?php echo $search_box_text; ?>';}" onfocus="if (this.value == '<?php echo $search_box_text; ?>') {this.value = '';}" value="<?php echo $search_box_text; ?>" name="s" class="txt_livesearch" /><span class="bt_search" id="bt_pp_search_<?php echo $id;?>"></span>
            </div>
            <?php			
			if ($cat_slug != '') { ?>
