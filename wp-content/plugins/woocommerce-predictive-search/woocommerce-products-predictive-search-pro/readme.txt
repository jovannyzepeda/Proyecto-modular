...
WooCommerce Predictive Search allows you to optimize your site search just the way you want it with 100% accuracy while delivering your customers stunning 'live search' results for your entire site.
...
* Fully customizable - define what get searched and what shows in the search box drop down.
...
Find detailed step-by-step set up and configuration instructions in the [plugins documents](http://docs.a3rev.com/user-guides/woocommerce/woo-predictive-search/) on the a3rev wiki.   
...
[Support](https://a3rev.com/forums/forum/woocommerce-plugins/predictive-search/)
...
1. WP admin > WooCommerce > Settings > Predictive Search Tab
...
Support and access to this plugin documents are available from the [HELP tab](https://a3rev.com/forums/forum/woocommerce-plugins/predictive-search/) on the Pro Versions Home page.
