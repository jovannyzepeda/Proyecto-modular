...
class WC_Predictive_Search_Global_Settings extends WC_Predictive_Search_Admin_UI
{
	...
	public function after_save_settings() {
		if ( ( isset( $_POST['bt_save_settings'] ) || isset( $_POST['bt_reset_settings'] ) ) && get_option( 'woocommerce_search_clean_on_deletion' ) == 'no' )  {
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				...
				'desc' 		=> __( 'On deletion (not deactivate) the plugin it will completely remove all of its code and tables it has created, leaving no trace it was ever here.', 'woops' ),
				'id' 		=> 'woocommerce_search_clean_on_deletion',
				'default'	=> 'no',
				'type' 		=> 'onoff_checkbox',
